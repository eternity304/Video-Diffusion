...
unset NCCL_P2P_DISABLE       # disable direct P2P, force host staging  

# if you are not using wth 8 gus, change `accelerate_config_machine_single.yaml` num_processes as your gpu number
CUDA_LAUNCH_BLOCKING=1 accelerate launch --config_file original/train_config.yaml --multi_gpu \
  -m original.train_dit \
